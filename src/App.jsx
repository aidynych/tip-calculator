...
function App() {
  ...
  let tipCalculation = ((bill * (tip / 100)) / people).toPrecision(3);
  return (
    <>
      <header>
        ...
        <div className="grid-item-1">
          ...
          <div className="container">
            <div className="flex-group">
              ...
              <label className={isPeople ? "visually-hidden" : "show"}>
                <span>Can not be zero</span>
              </label>
            </div>
            <div className="input-container">
              <i>
              ...
              <input
                className={isPeople ? "input" : "input have-error"}
                type="number"
                value={people}
                onChange={(e) => {
                  if (e.target.value === "0") {
        ...
        <div className="total-price-container">
          <div className="container-1">
            <div className="container-2">
              ...
              <p>
                <span>${tip === 0 || people === "" ? 0 : tipCalculation}</span>
              </p>
            </div>
            <div className="container-2">
              <div>
              ...
              <p>
                <span>
                  ${bill === 0 || people === "" ? 0 : totalCalculation}
                </span>
              </p>
            </div>
          </div>
